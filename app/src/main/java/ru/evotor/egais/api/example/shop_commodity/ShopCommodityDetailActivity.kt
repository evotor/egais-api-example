 ...
 * in a [ShopCommodityListActivity].
 */
class ShopCommodityDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            ...
            val fragment = ShopCommodityDetailFragment().apply {
                arguments = Bundle().apply {
                    putString(ShopCommodityDetailFragment.ARG_ITEM_ID,
                            intent.getStringExtra(ShopCommodityDetailFragment.ARG_ITEM_ID))
                }
            }
    ...
    override fun onOptionsItemSelected(item: MenuItem) =
            when (item.itemId) {
                android.R.id.home -> {
                    ...
                    navigateUpTo(Intent(this, ShopCommodityListActivity::class.java))
                    true
                }
