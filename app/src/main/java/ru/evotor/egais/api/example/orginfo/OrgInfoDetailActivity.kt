 ...
 * in a [OrgInfoListActivity].
 */
class OrgInfoDetailActivity : AppCompatActivity() {
        ...
        if (savedInstanceState == null) {
            ...
            val fragment = OrgInfoDetailFragment().apply {
                arguments = Bundle().apply {
                    putString(OrgInfoDetailFragment.ARG_ITEM_ID,
                            intent.getStringExtra(OrgInfoDetailFragment.ARG_ITEM_ID))
                }
            }

            supportFragmentManager.beginTransaction()
                    .add(R.id.orginfo_detail_container, fragment)
                    .commit()
        }
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem) =
            when (item.itemId) {
                android.R.id.home -> {
                    ...
                    navigateUpTo(Intent(this, OrgInfoListActivity::class.java))
                    true
                }
